...
BASELINE_GAP: dict[str, str] = {
    ...
    "ButterBandpass": _TODO,
    "ButterBandstop": _TODO,
    "ButterHighpass": _TODO,
    "CCI": _TODO,
    "Cart2Polar": _TODO,
    "Ceil": _TODO,
    "ContOFI": _TODO,
    ...
    "EwCorr": _TODO,
    "EwCov": _TODO,
    "EwGarmanKlassVar": _TODO,
    "EwGarmanKlassVol": _TODO,
    "EwKyleLambda": _TODO,
    "EwParkinsonVar": _TODO,
    "EwParkinsonVol": _TODO,
    "EwRogersSatchellVar": _TODO,
    "EwRogersSatchellVol": _TODO,
    "Floor": _TODO,
    "GreaterEqual": _TODO,
    "GreaterThan": _TODO,
    "Hampel": _TODO,
    ...
    "RollingGarmanKlassVar": _TODO,
    "RollingGarmanKlassVol": _TODO,
    "RollingHitRate": _TODO,
    "RollingHurst": _TODO,
    ...
    "RollingMedianAD": _TODO,
    "RollingMinMax": _TODO,
    "RollingOmega": _TODO,
    "RollingOrderImbalance": _TODO,
    "RollingParkinsonVar": _TODO,
    "RollingParkinsonVol": _TODO,
    "RollingPercentile": _TODO,
    "RollingRSI": _TODO,
    "RollingRange": _TODO,
    "RollingRank": _TODO,
    "RollingResidualStd": _TODO,
    "RollingRogersSatchellVar": _TODO,
    "RollingRogersSatchellVol": _TODO,
    "RollingSharpe": _TODO,
    "RollingSortino": _TODO,
    "RollingSpread": _TODO,
    "RollingTSF": _TODO,
    "RollingVWAP": _TODO,
    "RollingYangZhangVar": _TODO,
    "RollingYangZhangVol": _TODO,
    "Round": _TODO,
    "SchmittTrigger": _TODO,
    "SignedVolume": _TODO,
    "Sin": _TODO,
    "Square": _TODO,
    "Stoch": _TODO,
